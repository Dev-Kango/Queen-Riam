// Migrated from commands/stickertelegram.js
...
async function stickerTelegramCommand(sock, chatId, msg) {
    try {
        ...
        const botToken = '8146625839:AAFin2oR56Zk6T1Ajlar0ClCssED5jHXGMo';
...
bot({
  command: ['tg', 'tgsticker'],
  description: 'Get sticker from Telegram',
  category: 'photo',
